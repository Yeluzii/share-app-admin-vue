    ...
    <div :style="'width: calc(100% - ' + dialogProps.labelWidth! / 2 + 'px)'">
      ...
      >
        ...
        <el-form-item label="审核描述" prop="remark">
          <el-input v-model="dialogProps.row.remark" type="textarea" :rows="3" :disabled="dialogProps.isView" placeholder="请输⼊审核意⻅⻓度需要⼩于200字" />
        </el-form-item>
      </el-form>
    </div>
    <template #footer>
...
const rules = reactive({
  ...
  remark: [
    { required: true, message: '请输⼊审核描述', trigger: 'blur' },
    {
      min: 3,
      max: 200,
      message: '⻓度在 3 到 200 个字符',
      trigger: 'blur'
    }
  ]
})
